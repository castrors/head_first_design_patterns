import 'package:head_first_design_patterns/composite/menu/menu.dart';
import 'package:head_first_design_patterns/composite/menu/menu_component.dart';
import 'package:head_first_design_patterns/composite/menu/menu_item.dart';
import 'package:head_first_design_patterns/composite/menu/waitress.dart';
import 'package:test/test.dart';

void main() {

  test('Composite menu tests ', () {
